...
gen/ts:
	...
	find . -type f -wholename './ui/lib/waypoint-pb/*' | xargs sed -i '' -e 's/..\/..\/..\/google\/rpc\/status/api-common-protos\/google\/rpc\/status/g'
	find . -type f -wholename './ui/lib/waypoint-client/*' | xargs sed -i '' -e 's/..\/..\/..\/google\/rpc\/status/api-common-protos\/google\/rpc\/status/g'
	find . -type f -wholename './ui/lib/waypoint-client/*' | xargs sed -i '' -e 's/.\/server_pb/waypoint-pb/g'
	find . -type f -wholename './ui/lib/waypoint-client/*' | xargs sed -i '' -e 's/..\/..\/..\/internal\/server\/protwaypoint-pb/waypoint-pb/g'
